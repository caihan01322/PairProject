...
public class MyServiceImpl implements MyService {
    ...
    public List<Academics> findAllArticlesList() {
        return myDao.findAllArticleList();
    }
    ...
    public void addAcademic(Academics academics) {
        myDao.addAcademic(academics);
    }

    public void updateAcademic(Academics academics) {
        myDao.updateAcademic(academics);
    }
