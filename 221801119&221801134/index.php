        ...
        <div class="container u-flex">
            ...
            <nav class="header-nav">
                <ul class="subnav-ul">
                    ...
                    <li class="menu-item"><a   data-id="37" data-adid="41" href="view/import.php">论文导入</a></li>
                    <li class="menu-item"><a   data-id="37" data-adid="41" href="view/manage.php">论文管理</a></li>
                    <li class="menu-item"><a data-id="37" data-adid="41" href="view/analysis.php">动态分析</a></li>
                </ul>
            </nav>
            <div class="metabar__right u-flex">
                ...
                <div class="metabarItem u-flex u-cursorPointer" v-on:click="switchSearch"><a href="view/collect.php" class="u-flex" title="进入收藏夹" >
                ...
                <div class="metabarItem u-flex u-paddingLeft20 dropdown" >
                    ...
                    echo '<a href="" class="u-flex" title="用户" >
