		...
		if( $res->num_rows >0 ){
         ...
         <div class="siders" style="margin-left:0px;padding:0%;">
        	<div style="margin-left:0px;padding:15px 8%;">
        			...
        			<span style="position: relative;top:-5px;color:#707070"><small>'.$row["time"].'</small></span></div>
        	</div>
        </div>
                ';
		    }
...
<div class="mainPaper2" style="margin-left: 0;position:relative;left:-15px">
    	...
    	?>
<div class="paper">
	          <div class="page-wrapper"><div><span id="paperContent">
	  <?php 
