...
(function(c) {
    ...
    function p(c, k, h, n) { c.hasOwnProperty(k) || (c[k] = n.apply(null, h)) }
    c = c ? c._modules : {};
    p(c, "Extensions/FullScreen.js", [c["Core/Chart/Chart.js"], c["Core/Globals.js"], c["Core/Renderer/HTML/AST.js"], c["Core/Utilities.js"]],
        function(c, k, h, n) {
            ...
            k.Fullscreen = n;
            l(c, "beforeRender", function() { this.fullscreen = new k.Fullscreen(this) });
            return k.Fullscreen
        });
    ...
    p(c, "Extensions/Exporting.js", [c["Core/Chart/Chart.js"], c["Mixins/Navigation.js"], c["Core/Globals.js"], c["Core/Options.js"], c["Core/Color/Palette.js"], c["Core/Renderer/SVG/SVGRenderer.js"], c["Core/Utilities.js"]], function(c, k, h, n, l, p, e) {
        ...
        var x = e.addEvent,
            ...
            J = e.removeEvent,
            K = e.uniqueKey;
        A(n.lang, { viewFullscreen: "View in full screen", exitFullscreen: "Exit from full screen", printChart: "Print chart", downloadPNG: "Download PNG image", downloadJPEG: "Download JPEG image", downloadPDF: "Download PDF document", downloadSVG: "Download SVG vector image", contextButtonTitle: "Chart context menu" });
        n.navigation ||
            (n.navigation = {});
        v(!0, n.navigation, { buttonOptions: { theme: {}, symbolSize: 14, symbolX: 12.5, symbolY: 10.5, align: "right", buttonSpacing: 3, height: 22, verticalAlign: "top", width: 24 } });
        v(!0, n.navigation, {
            menuStyle: { border: "1px solid " + l.neutralColor40, background: l.backgroundColor, padding: "5px 0" },
            menuItemStyle: { padding: "0.5em 1em", color: l.neutralColor80, background: "none", fontSize: G ? "14px" : "11px", transition: "background 250ms, color 250ms" },
            menuItemHoverStyle: { background: l.highlightColor80, color: l.backgroundColor },
        ...
        h.post = function(a, b, f) {
            var d = y("form", v({ method: "post", action: a, enctype: "multipart/form-data" }, f), { display: "none" }, z.body);
            F(b, function(a, b) { y("input", { type: "hidden", name: b, value: a }, null, d) });
            d.submit();
            E(d)
        };
        ...
        A(c.prototype, {
            ...
            getSVG: function(a) {
                ...
                var d = y("div",
                    null, { position: "absolute", top: "-9999em", width: this.chartWidth + "px", height: this.chartHeight + "px" }, z.body);
                ...
                A(f.chart, { animation: !1, renderTo: d, forExport: !0, renderer: "SVGRenderer", width: e, height: r });
                f.exporting.enabled = !1;
                delete f.data;
                f.series = [];
                this.series.forEach(function(a) {
                    b =
                        v(a.userOptions, { animation: !1, enableMouseTracking: !1, showCheckbox: !1, visible: a.visible });
                    b.isInternal || f.series.push(b)
                });
                this.axes.forEach(function(a) { a.userOptions.internalKey || (a.userOptions.internalKey = K()) });
                ...
                this.axes.forEach(function(a) {
                    var b = H(h.axes, function(b) { return b.options.internalKey === a.userOptions.internalKey }),
                        d = a.getExtremes(),
                        f = d.userMin;
                    d = d.userMax;
                    b && ("undefined" !==
            ...
            getSVGForExport: function(a, b) { var f = this.options.exporting; return this.getSVG(v({ chart: { borderRadius: 0 } }, f.chartOptions, b, { exporting: { sourceWidth: a && a.sourceWidth || f.sourceWidth, sourceHeight: a && a.sourceHeight || f.sourceHeight } })) },
            ...
            contextMenu: function(a, b, f, d, c, h, k) {
                ...
                if (!m) {
                    ...
                    var l = y("ul", { className: "highcharts-menu" }, { listStyle: "none", margin: 0, padding: 0 }, m);
                    g.styledMode || u(l, A({ MozBoxShadow: "3px 3px 10px #888", WebkitBoxShadow: "3px 3px 10px #888", boxShadow: "3px 3px 10px #888" }, r.menuStyle));
                    m.hideMenu = function() {
                        u(m, { display: "none" });
                        k && k.setState(0);
                        g.openMenu = !1;
                    ...
                    g.exportEvents.push(x(m, "mouseleave", function() { m.hideTimer = B.setTimeout(m.hideMenu, 500) }), x(m, "mouseenter", function() { e.clearTimeout(m.hideTimer) }),
                        x(z, "mouseup", function(b) { g.pointer.inClass(b.target, a) || m.hideMenu() }), x(m, "click", function() { g.openMenu && m.hideMenu() }));
                    b.forEach(function(a) {
                        ...
                        if (I(a, !0)) {
                            if (a.separator) var b = y("hr", null, null, l);
                                ...
                                g.options.lang[a.textKey])), g.styledMode || (b.onmouseover = function() { u(this, r.menuItemHoverStyle) }, b.onmouseout = function() { u(this, r.menuItemStyle) }, u(b, A({ cursor: "pointer" }, r.menuItemStyle)));
            ...
            addButton: function(a) {
                ...
                if (!1 !== d.enabled) {
                    ...
                    d.text && d.symbol ? g.paddingLeft = q(g.paddingLeft, 30) : d.text || A(g, { width: d.width, height: d.height, padding: 0 });
                    b.styledMode || (g["stroke-linecap"] = "round", g.fill = q(g.fill, l.backgroundColor), g.stroke = q(g.stroke, "none"));
                    var t = f.button(d.text, 0, 0, C, g, n, k).addClass(a.className).attr({ title: q(b.options.lang[d._titleKey || d.titleKey], "") });
                    t.menuClassName = a.menuClassName ||
                        "highcharts-menu-" + b.btnCount++;
                    if (d.symbol) {
                        var m = f.symbol(d.symbol, d.symbolX - h / 2, d.symbolY - h / 2, h, h, { width: h, height: h }).addClass("highcharts-button-symbol").attr({ zIndex: 1 }).add(t);
                        b.styledMode || m.attr({ stroke: d.symbolStroke, fill: d.symbolFill, "stroke-width": d.symbolStrokeWidth || 1 })
                    }
                    t.add(b.exportingGroup).align(A(d, { width: t.width, x: q(d.x, b.buttonOffset) }), !0, "spacingBox");
        ...
        c.prototype.renderExporting = function() {
            ...
            d && !1 !== b.enabled && (a.exportEvents = [], a.exportingGroup = a.exportingGroup || a.renderer.g("exporting-group").attr({ zIndex: 3 }).add(), F(c, function(b) { a.addButton(b) }), a.isDirtyExporting = !1)
        };
        x(c, "init", function() {
            var a =
                this;
