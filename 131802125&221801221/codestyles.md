...
注意上面例子中的元素缩进; 你可以在本文的 [:ref:`缩进 `](https://github.com/pythonpeixun/zh-google-styleguide/blob/master/google-python-styleguide/python_style_rules.rst#id4) 部分找到解释.
...
绝对不要用tab, 也不要tab和空格混用. 对于行连接的情况, 你应该要么垂直对齐换行的元素(见 [:ref:`行长度 `](https://github.com/pythonpeixun/zh-google-styleguide/blob/master/google-python-styleguide/python_style_rules.rst#id8) 部分的示例), 或者使用4空格的悬挂式缩进(这时第一行不应该有参数):
