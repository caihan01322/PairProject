...
<form id="main">
    ...
    <nav v-bind:class="active" v-on:click>
        ...
        <a href="#" class="index" v-on:click="makeActive('index')">A</a>
        ...
        <a href="Login.jsp" class="login" v-on:click="makeActive('login')">D</a>

    </nav>

    <div class="bar">
        <!-- searchString 模型与文本域创建绑定 -->
        <input type="text" v-model="searchString" placeholder="input" />
    </div>
